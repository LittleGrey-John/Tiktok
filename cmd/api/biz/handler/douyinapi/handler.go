...
func VideoUserToApiUser(videoUser *douyinvideo.User, apiUser *douyinapi.User) *douyinapi.User {
	apiUser.ID = videoUser.Id
	apiUser.Name = videoUser.Name
	apiUser.FollowCount = *videoUser.FollowCount
	apiUser.FollowerCount = *videoUser.FollowerCount
	apiUser.Avatar = "empty"
